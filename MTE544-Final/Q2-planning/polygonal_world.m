...
function [a,b,ptsStore] = polygonal_world(posMinBound, posMaxBound, ...
    minLen, maxLen, numObsts, startPos, endPos, obst_buffer, max_count)
...
for i = 1:1:numObsts
    ...
    while(1)
        ...
        pos(i,:) = posMinBound + [rand(1)*(posMaxBound(1)-posMinBound(1)),...
            rand(1)*(posMaxBound(2)-posMinBound(2))];
